      ...
      <hr />
        ...
        <Link to={'https://bootswatch.com/'} style={{ textDecoration:'none'}}>BootsWatch</Link>           
          ...
          <div className="col-lg-3 d-flex flex-column ">
            <br />
            <h4>Services</h4>
        <Link  style={{textDecoration:'none'}} className='text-primary'>Adoption</Link>
        <Link  style={{textDecoration:'none'}} className='text-primary'>Rehoming</Link>
        <Link  style={{textDecoration:'none'}} className='text-primary'>Customer Support</Link>
          ...
          <div className="col-lg-2 d-flex flex-column ms-5">
            <br />
          <h3>Contact Us</h3>
         <div>
